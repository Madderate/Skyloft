...
public class InterfaceManager {
     ...
     * 参数：关键词keywords String，type String。返回StateCode对象
     * TODO
     */
     ...
     * 参数：音乐id String，移动端mobile String，返回StateCode对象
     */
    public String getLyric(String id){
        return jsonToClass.getMusicLyric("/lyric","id="+id);
    }
     ...
     * TODO
     */
    public ArrayList<MusicInfo> getAlbumDetail(String id){
        return jsonToClass.getMusicInfoResult("/album","id="+id);
    }
     ...
     * 参数：取出数量limit String, 默认为 25 偏移数量，offset String, 用于分页 默认 为 0
     * TODO
     */
     ...
     * 参数：专辑id id String,是否收藏t String,1 为收藏,其他为取消收藏
     * 返回:StateCode
     */
     ...
     * 参数：歌单id id String,歌单描述desc String
     * 返回:StateCode
     */
     ...
     * 参数：歌单id id String,歌单名name String
     * 返回:StateCode对象..
     */
     ...
     * 参数：歌单id id String,歌单标签tags String
     * 返回:StateCode
     */
     ...
     * 参数：歌曲列表ids String，歌单id pid String
     * 返回：StateCode
     */
